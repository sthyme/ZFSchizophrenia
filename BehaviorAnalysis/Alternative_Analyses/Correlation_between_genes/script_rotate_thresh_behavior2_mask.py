...
def my_clustermap(matrix,thrs_row=1,thrs_col=1,distM=None,row_cls=False,col_cls=True,return_fig=False,method='average',fig_sz=(8,8),colnames=None, rownames=None,cls_info=False):
    ...
    list_to_mask=['c11orf87','dgki','sept3','ppp1r16b','sez6l2','immp2l','fxr1','otud7b','zswim6','ptn','ncan','tmtc1','nab2','kcnv1','r3hdm2','chrna5','cyp17a1','gtdc1','srpk2','cacna1i','epc2','satb2','srr','slc32a1','glt8d1','ftcdnl1','ogfod2','adamtsl3','sdccag8','srebf2','plch2a','slc38a7','slc39a8','nfkb1','kif5c','nxph4','dpyd','ngef','hapln4','apopt1','ina','mbd5','sybu','kctd13','lrriq3','arl6ip4','klc1','c2orf82','nrgn','gatad2a','nck1','grm3','fut9a','fes','galnt10','anp32e','slc35g2','snx19','plcl1','c12orf65','bag5','tbc1d5','mdk','negr1','pak6b','cntn4','ca8','man2a1','kcnj13','tcf20','stat6','cnksr2','ckb','tcf4','shmt2','znf804a','sipa1l1','arl3','tle1','doc2a','c10orf32','mad1l1']
    print (matrix)
  ...
  #  if row_cls:
    ...
    plt.savefig("Dec_corr_MASKING_sort1_"+method+".png",bbox_inches='tight', dpi=600)
