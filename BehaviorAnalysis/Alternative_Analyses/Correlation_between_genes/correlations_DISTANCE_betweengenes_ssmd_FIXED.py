...
Db=pd.read_csv("ssmd_stimulusonly_FIXED_onlyifpsig.csv")
...
#		print dist
	...
	#		newdf = newdf.dropna()
		corrlist.append( (corr, newdf, column1, column2))
...
dfcor.to_csv("SSMD_FIXEDPSIG_dec_correlation_sort1.csv")
#dfdist.to_csv("SSMD_dec_distance_sort1.csv")
