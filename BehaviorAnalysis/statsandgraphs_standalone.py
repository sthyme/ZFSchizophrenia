...
"centerfrac_10min": ("Time (min)", "Fraction of bout time in well center"),
"centerfrac_min": ("Time (min)", "Fraction of bout time in well center"),
"averhofrac_10min": ("Time (min)", "Average rho / maximum rho"),
"averhofrac_min": ("Time (min)", "Average rho / maximum rho"),
"aveboutdisp_min": ("Time (min)", "Average bout speed (pixel / ms)"),
"aveboutdisp_10min": ("Time (min)", "Average bout speed (pixel / ms)"),
"aveboutdist_min": ("Time (min)", "Average bout distance (pixel)"),
"aveboutdist_10min": ("Time (min)", "Average bout distance (pixel)"),
"secper_min": ("Time (min)", "Active second / minute"),
"minper_10min": ("Time (min)", "Active min / 10 min"),
"aveboutvel_min": ("Time (min)", "Average bout velocity (pixel / ms)"),
"aveboutspeed_min": ("Time (min)", "Average bout speed (pixel / ms)"),
"aveboutvel_10min": ("Time (min)", "Average bout velocity (pixel / ms)"),
"aveboutspeed_10min": ("Time (min)", "Average bout speed (pixel / ms)"),
"aveboutcumdpix_10min": ("Time (min)", "Average bout cumulative DPIX (pixel)"),
"aveboutcumdpix_min": ("Time (min)", "Average bout cumulative DPIX (pixel)"),
"interboutinterval_min": ("Time (min)", "Average interbout interval (sec)"),
"interboutinterval_10min": ("Time (min)", "Average interbout interval (sec)"),
"avebouttime_min": ("Time (min)", "Average bout time (ms)"),
"avebouttime_10min": ("Time (min)", "Average bout time (ms)"),
"numberofbouts_min": ("Time (min)", "Number of bouts / min"),
"numberofbouts_10min": ("Time (min)", "Number of bouts / 10 min"),
...
def box_plot(array1, array2, type, ylabel):
  ...
  if os.path.exists(boxgraphname):
		return
	dictdata = {}
...
def ribbon_plot(array1, array2, type, xlabel, ylabel, t = None):
	...
	if os.path.exists(ribgraphname):
		return
	fig = plt.figure()
	ax1 = fig.add_subplot(121)
